...
class SavingsAccountServicePJ implements AccountCyclePJ<SavingsAccount, CustomerPJ> {
    ...
    @Override
    public void withdrawal(SavingsAccount account, BigDecimal withdrawValue) throws AccountException {
